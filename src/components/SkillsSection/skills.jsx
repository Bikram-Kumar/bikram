...
export default function SkillsSection() {
    return (
        <div className="w-full bg-neutral-950 py-8">
            <div className="flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4">
                    ...
                    <SkillBox heading={"Backend Development"} skills={["springboot", "nextjs", "express"]} desc="As a backend developer, I create scalable and efficient server-side applications, robust database architectures, and seamless API integrations that power fast, secure, and reliable digital experiences." />
                    <SkillBox heading={"Database Management"} skills={["mongodb", "postgresql", "mysql", "firebase"]} desc="By harnessing the power of SQL and NoSQL databases, I create flexible and high-performance data management systems that support complex applications and drive business success." />
